...
var ControlWrapper = function (_Component) {
  ...
  function ControlWrapper() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ControlWrapper.__proto__ || Object.getPrototypeOf(ControlWrapper)).call.apply(_ref, [this].concat(args))), _this), _this.validate = function () {
      var validationMessage = "";
      if (!_this.inputRef.current.validity.valid) {
        if (_this.inputRef.current.validity.valueMissing) {
